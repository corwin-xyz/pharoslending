  ...
  try {
    ...
    window.ethereum
      ...
      .then(() => {
        ...
        contractLendBorrow = new web3.eth.Contract(
          contractsData.lendBorrow.abi,
          contractsData.lendBorrow.address
        );
...
export { web3, contractLendBorrow };
