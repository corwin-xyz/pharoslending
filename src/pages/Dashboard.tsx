            ...
            <Card className='w-full mb-4'>
              ...
              <CardContent>
                <div className='grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3'>
                  ...
                  <div className='space-y-1'>
                    <p className='text-sm font-medium'>USDC Supply APY</p>
              ...
              <CardContent>
                <div className='grid gap-4 md:grid-cols-2'>
                  <div className='space-y-4'>
                    <div className='space-y-1'>
                      <p className='text-sm font-medium'>Supplied USDC</p>
                      <p className='text-2xl font-bold'>
                    ...
                    <div className='space-y-1'>
                      ...
                      <p className='text-xl font-bold'>
                        {(balance*13/100).toFixed(2)} USDC
                      </p>
                      <p className='text-xs text-muted-foreground'>
                        Base interest rate: 13.2% APY
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='grid gap-4 md:grid-cols-2'>
                    <div className='space-y-4'>
                      <div className='space-y-1'>
                        ...
                        <p className='text-2xl font-bold'>
                          {userData.borrowedAmount.toFixed(2)} USDC
                        </p>
                      </div>
                    ...
                    <div className='space-y-4'>
                      <div className='space-y-1'>
                        ...
                        <p className='text-xl font-bold'>
                          {userData.collateralAmount.toFixed(2)} PHAR
                        </p>
                        <p className='text-xs text-muted-foreground'>
                          Collateral Ratio:{' '}
